...
function Remove() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError("")
    try {
      const response = await fetch("http://localhost:8000/services/remove", {
        method: "POST",
        headers: {
      ...
      console.log("error occured at remove service")
    }
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center px-4">
      ...
      >
        <h2 className="text-2xl font-bold mb-6 text-indigo-600 text-center">Remove Contact</h2>
